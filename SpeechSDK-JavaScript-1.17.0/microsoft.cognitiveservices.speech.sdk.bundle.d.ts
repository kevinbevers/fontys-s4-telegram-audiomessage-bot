...
export class VoiceProfileClient {
        ...
        /**
            ...
            * @param err - Callback invoked in case of an error.
            */
        getAuthorizationPhrasesAsync(lang: string, cb?: (e: VoiceProfileAuthorizationPhraseResult) => void, err?: (e: string) => void): void;
        /**
            * Create a speaker recognition voice profile
...
export class SpeakerIdMessageAdapter {
        ...
        /**
            ...
            */
        getAuthorizationPhrases(lang: string): Promise<IRestResponse>;
        /**
